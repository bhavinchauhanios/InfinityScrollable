...
//  InfinityScrollable
//
//  Created by Bhavin Chauhan on 17/05/18.
...
class InfinityImageLoadVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        collectionView?.register(UICollectionViewCell.self, forCellWithReuseIdentifier: "InfinityImagesLoadCollectionViewCell")
    ...
    // MARK: UICollectionView
     ...
     func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "InfinityImagesLoadCollectionViewCell", for: indexPath)
        cell.backgroundColor = UIColor(white: 235.0 / 255.0, alpha: 1.0)
        
        //ImageView add in to cell
        let imageView = imageViewForCell(cell)
        
        var options = ImageLoadingOptions()
        options.pipeline = pipeline
        
        //Load url images here!
        Nuke.loadImage(
    ...
    //MARK: CollectionView Cell Height And Width Setup Here!
